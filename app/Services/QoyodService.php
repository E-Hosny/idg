...
class QoyodService
{
    ...
    {
        try {
            // Remove reference to let Qoyod generate it automatically
            if (isset($invoiceData['invoice']['reference'])) {
                unset($invoiceData['invoice']['reference']);
            }
            
            Log::info('Creating invoice in Qoyod', [
                'invoice_data' => $invoiceData,
                'note' => 'Reference will be auto-generated by Qoyod'
            ]);
            ...
            if ($response->successful()) {
                ...
                Log::info('Invoice created successfully in Qoyod', [
                    ...
                    'note' => $data['invoice']['reference'] ? 'Reference assigned by Qoyod' : 'Draft invoice - no reference yet'
                ]);
